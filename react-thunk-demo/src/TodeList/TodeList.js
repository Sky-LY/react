...
import { inputChangeAction, addItemAction, deleteItemAction, getTodeList } from '../store/actionCreators'
...
class TodeList extends Component {
    constructor(props) {
        ...
        store.subscribe(this.storeChange) //订阅store的状态改变
